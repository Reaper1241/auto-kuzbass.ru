...
const title = computed(() => {
  if ($route.params.car) {
    ...
    return `Китайские автомобили ${cleanUpTitle($route.params.brand, $route.params.model).toUpperCase()} в наличии`;
  } else if ($route.params.brand) {
    return `Китайские автомобили ${cleanUpTitle($route.params.brand).toUpperCase()} в наличии`;
  } else {
    return 'Китайские автомобили в наличии';
  }
});
  ...
  <section class="section" v-else-if="!isLoading && carsCount === 0">
    <div class="container">
      <div class="no-cars-message">
        <h3>Китайские автомобили не найдены</h3>
  ...
  <section class="section" v-else-if="isLoading">
    <div class="container">
      <div class="loading-message">
        Загрузка китайских автомобилей...
      </div>
    </div>
  </section>
</template>
