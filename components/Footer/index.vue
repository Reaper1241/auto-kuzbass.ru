        ...
        <section class="footer__top">
          ...
          <div class="footer__top-right">
            ...
            <div class="footer__info">
              ...
              <p>
                Юр. лицо: ООО «Лекс», ИНН: 9727083888, ОГРН: 1247700570809, КПП: 772701001 Юр. адрес: 117449, Москва , Шверника ул., д. 16 к. 1, помещ. 1/ П График работы: с 9:00 до 21:00
              </p>
...
.footer {
    ...
    .footer__top {
        ...
        .footer__contacts {
            color: #0091B9; // красный цвет иконок и текста
            font-size: 16px;
            padding: 10px;
            display: flex;
            flex-direction: column;
